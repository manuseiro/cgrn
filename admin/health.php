        ...
        <div class="card mt-5 p-4 border-0 shadow-sm bg-primary text-white">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mb-0 small">Se algum serviço essencial (como SICAR ou IBAMA) estiver
                        <strong>Offline</strong>, considere ativar o <strong>Aviso Global</strong> no menu de
                        configurações para informar os usuários.
                    </p>
                </div>
