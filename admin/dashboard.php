...
<body>
    ...
    <div class="sidebar shadow">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link" href="layers.php"><i class="bi bi-layers-fill"></i>Camadas (Custom)</a>
    ...
    <div class="main-content">
        <header class="d-flex justify-content-between align-items-center mb-5">
            <div>
                ...
                <p class="text-muted small">Gerenciamento central do CGRN v3.7.1</p>
            </div>
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-md-4">
                <div class="card p-3 h-100 border-0 shadow-sm border-start border-warning border-5">
                    ...
                    <h3 class="fw-bold mb-0" style="font-size: 1.2rem;"><?php echo date('H:i:s', strtotime($lastLog)); ?></h3>
                ...
                <div class="card p-4 border-0 shadow-sm h-100">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <form class="d-flex gap-2" method="GET">
                            <input type="text" name="ip" class="form-control form-control-sm" placeholder="Filtrar IP..." value="<?php echo htmlspecialchars($_GET['ip'] ?? ''); ?>">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle small">
                            ...
                            <tbody>
                                ...
                                if($ipFilter) { $sql .= " AND ip_address = ?"; $params[] = $ipFilter; }
                    ...
                    <div class="text-center mt-3">
                        <a href="reports.php" class="btn btn-link btn-sm text-decoration-none">Ver relatório completo <i class="bi bi-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card p-4 border-0 shadow-sm">
                    ...
                    <div class="list-group list-group-flush small">
                        <a href="layers.php" class="list-group-item list-group-item-action px-0"><i class="bi bi-layers me-2 text-primary"></i> Camadas Personalizadas</a>
                        <a href="settings.php" class="list-group-item list-group-item-action px-0"><i class="bi bi-shield-check me-2 text-success"></i> Segurança e SEO</a>
                        <a href="proxy.php" class="list-group-item list-group-item-action px-0"><i class="bi bi-hdd-network me-2 text-info"></i> Proxy Whitelist</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        async function runTask(task) {
            ...
            try {
                const response = await fetch('maintenance_actions.php?task=' + task);
